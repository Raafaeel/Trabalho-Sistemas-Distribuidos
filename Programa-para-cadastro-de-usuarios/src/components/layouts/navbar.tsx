...
export default function Navbar() {
  ...
  return (
    <nav className="font-sans flex flex-col sm:flex-row sm:justify-between items-center sm:items-baseline py-4 px-6 bg-transparent text-black shadow w-full">
      ...
      <div className="flex flex-col sm:flex-row mt-4 sm:mt-0">
        ...
        {usuarioAutenticado ? (
  <>
        <a href="/editar" className="text-lg no-underline text-black hover:text-[#0040ff] mx-2">
         Editar Usuario
        </a>
  ...
  <>
    ...
    <a href="/cadastro" className="text-lg no-underline text-black hover:text-[#0040ff] mx-2">
      Cadastro
    </a>
  </>
)}
